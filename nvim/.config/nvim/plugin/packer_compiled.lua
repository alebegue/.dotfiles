...
_G.packer_plugins = {
  ...
  ["lspkind-nvim"] = {
    loaded = true,
    path = "/home/adrien/.local/share/nvim/site/pack/packer/start/lspkind-nvim",
  ...
  ["nvim-colorizer.lua"] = {
    loaded = true,
    path = "/home/adrien/.local/share/nvim/site/pack/packer/start/nvim-colorizer.lua",
  ...
  ["rust-tools.nvim"] = {
    loaded = true,
    path = "/home/adrien/.local/share/nvim/site/pack/packer/start/rust-tools.nvim",
